    ...
    <header>
        <nav class="navbar navbar-dark bg-dark">
            <ul class="nav nav-pills">
                <li class="nav-item"><a href="serviceCenter.php" class="nav-link px-2 text-secondary">Service Center</a></li>
                <li class="nav-item"><a href="registoTrabalhos.php" class="nav-link px-2 text-light">Trabalhos</a></li>
